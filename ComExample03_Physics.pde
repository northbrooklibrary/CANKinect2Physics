// Kinect Physics Example by Amnon Owed (15/09/12), edited by Arindam Sen (10/11/16)
// edited by Hugh Sato for Kinect2 using org.openkinect.processing (4/26,18)
...
// Set thresholding
final int minDepth =  100;
final int maxDepth =  1400;
...
// PImage to hold thresholded depthImage from kinect2
PImage cam;
...
void setup() {
  ...
  cam = new PImage(kinect2.depthWidth, kinect2.depthHeight);

  // calculate the reScale value
  // currently it's rescaled to fill the complete width (cuts off top-bottom)
